...
@section('content')
    <div class="container">
        ...
        <form class="form-horizontal" method="POST" action="{{ route('updateVe_status',$ve_statuses->id) }}">
            {{ csrf_field() }}
            <br>
            <div>
                @if(isset($mess))
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control" name="name" value="{!! $ve_statuses->name !!}"
                           required>
                </div>
            </div>
